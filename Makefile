...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/03/26 13:54:40 by ysushkov          #+#    #+#              #
#    Updated: 2018/03/29 18:49:05 by ysushkov         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
	...
	ft_strcmp.c ft_strncmp.c ft_atoi.c ft_isdigit.c ft_isalpha.c ft_isalnum.c \
	...
	ft_isupper.c ft_islower.c ft_ascii_sort.c ft_isodd.c ft_iseven.c
...
$(NAME):
	...
	ar rc $(NAME) ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	...
	ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o ft_isdigit.o ft_isalpha.o \
	...
	ft_lstiter.o ft_lstmap.o ft_isupper.o ft_islower.o ft_ascii_sort.o \
	ft_isodd.o ft_iseven.o
	ranlib $(NAME)

clean:
	/bin/rm -f ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	ft_memchr.o	ft_memcmp.o ft_strlen.o ft_strdup.o ft_strcpy.o ft_strncpy.o \
	ft_strcat.o	ft_strncat.o ft_strlcat.o ft_strchr.o ft_strrchr.o ft_strstr.o \
	ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o ft_isdigit.o ft_isalpha.o \
	ft_isalnum.o ft_isascii.o ft_isprint.o ft_toupper.o ft_tolower.o \
